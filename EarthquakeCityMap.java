...
public class EarthquakeCityMap extends PApplet {
	...
	public void addkey2() {
		...
		textAlign(LEFT, CENTER);
		textSize(12);
		text("NAVIGATE WITH\n   KEYBOARD", xbase+25, ybase+25);
		

		fill(0, 0, 0);
		textAlign(LEFT, CENTER);
		text("W - to move Up", xbase+25, ybase+55);
		
		fill(0, 0, 0);
		textAlign(LEFT, CENTER);
		text("S - to move Down", xbase+25, ybase+75);
		
		fill(0, 0, 0);
		textAlign(LEFT, CENTER);
		text("A - to move Left", xbase+25, ybase+95);
		
		fill(0, 0, 0);
		textAlign(LEFT, CENTER);
		text("D - to move Right", xbase+25, ybase+115);
		
		fill(0, 0, 0);
		textAlign(LEFT, CENTER);
		text("Press D+S, A+W,\n    W+D, A+S \nto move diagonaly", xbase+25, ybase+155);
